    ...
    <div className="min-h-screen bg-surface text-slate">
      ...
      <main className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24">
        <section className="space-y-6 text-center">
          ...
          <h1 className="text-balance text-3xl font-bold text-slate sm:text-4xl">Logistics Services</h1>
        ...
        <section className="mt-16 rounded-[2rem] bg-white p-6 shadow-soft sm:mt-20 sm:p-10">
          <div className="grid gap-8 lg:grid-cols-[1.25fr_0.75fr] lg:items-center lg:gap-10">
            <div className="min-w-0">
              <h2 className="text-balance text-xl font-semibold text-slate sm:text-2xl">Why Choose Champion Logistics?</h2>
              <p className="mt-4 max-w-xl text-pretty text-base leading-8 text-slate/80">
        ...
        <section className="mt-16 rounded-[2rem] bg-primary/5 p-6 text-slate shadow-soft sm:mt-20 sm:p-10">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            <div className="min-w-0">
              <h2 className="text-balance text-xl font-semibold sm:text-2xl">Expand Your Reach</h2>
              <p className="mt-2 text-pretty text-sm text-slate/80">Get more information about pricing and custom plans.</p>
            </div>
