    ...
    <div className="min-h-screen bg-surface text-slate">
      ...
      <main>
        ...
        <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24">
          <div className="grid gap-10 lg:grid-cols-[0.75fr_1fr] lg:items-center lg:gap-16">
            <div className="min-w-0 space-y-6">
              <p className="text-sm uppercase tracking-[0.24em] text-slate/60">About Us</p>
              <h2 className="text-balance text-2xl font-semibold text-slate sm:text-3xl">Reliable freight shipping with Champion Shipping Logistics</h2>
              <p className="max-w-2xl text-pretty text-base leading-8 text-slate/80">
        ...
        <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24">
          <div className="space-y-6 text-center">
            ...
            <h2 className="text-balance text-2xl font-semibold text-slate sm:text-3xl">Tailored logistics services for your business</h2>
          </div>
        ...
        <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24">
          <div className="space-y-6">
            ...
            <p className="max-w-xl text-pretty text-base leading-8 text-slate/80">Select a state to see our service locations for car shipping and delivery.</p>
        ...
        <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24">
          <div className="grid gap-10 lg:grid-cols-[2fr_1fr] lg:items-center">
            <div className="min-w-0 space-y-6">
              ...
              <h2 className="text-balance text-2xl font-semibold text-slate sm:text-3xl">Certifications & Customer Satisfaction</h2>
              <p className="max-w-xl text-pretty text-base leading-8 text-slate/80">
        ...
        <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24">
          <div className="rounded-[2rem] bg-primary/5 p-5 sm:p-8">
            <div className="max-w-2xl space-y-6">
              <p className="text-sm uppercase tracking-[0.24em] text-primary">Contact</p>
              <h2 className="text-balance text-2xl font-semibold text-slate sm:text-3xl">Contact Us</h2>
              <p className="max-w-xl text-pretty text-base leading-8 text-slate/80">
