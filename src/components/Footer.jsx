...
export default function Footer() {
  return (
    <footer className="border-t border-slate/10 bg-white py-12 sm:py-16">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:gap-12 sm:px-6 lg:grid-cols-[1.5fr_1fr]">
        <div className="space-y-4">
          <p className="text-sm uppercase tracking-[0.24em] text-slate/60">Champion Logistics</p>
          <p className="max-w-xl text-pretty text-sm leading-7 text-slate/80">
