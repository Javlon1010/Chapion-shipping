...
export default function LocalGuidesMap({ selectedState, onStateClick }) {
  ...
  return (
    <div className="overflow-hidden rounded-[2rem] bg-gradient-to-b from-sky-100 via-slate-100 to-white p-4 shadow-soft sm:p-6">
      <div className="grid gap-6">
        <div className="min-w-0 space-y-5">
          <div className="space-y-2">
            <p className="text-sm uppercase tracking-[0.28em] text-slate/60">Champion Logistics Local Guides</p>
            <h2 className="text-balance text-2xl font-semibold text-slate sm:text-3xl">Explore service coverage across the United States</h2>
            <p className="max-w-2xl text-pretty text-sm leading-7 text-slate/70">
      ...
      <div className="mt-8 overflow-hidden rounded-[2rem] bg-slate-950 p-3 sm:p-4">
        <div className="h-[300px] w-full sm:h-[400px] md:h-[520px]">
          <ComposableMap
