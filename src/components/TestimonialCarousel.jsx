...
export default function TestimonialCarousel() {
  ...
  return (
    <section className="space-y-8 rounded-[2rem] bg-surface p-5 shadow-soft sm:p-8">
      <div className="flex items-center justify-between gap-4">
        <div>
          <p className="text-sm uppercase tracking-[0.24em] text-slate/60">Client Feedback</p>
          <h2 className="text-balance text-2xl font-semibold text-slate">What Our Clients Love</h2>
        </div>
      ...
      <blockquote className="min-w-0 rounded-3xl bg-white p-5 text-slate shadow-soft sm:p-8">
        <p className="text-pretty text-lg leading-8">"{item.quote}"</p>
