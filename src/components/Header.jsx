  ...
  return (
    <header className="sticky top-0 z-40 border-b border-slate/10 bg-white/95 backdrop-blur-lg">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 sm:py-4">
        <Link href="/" className="flex min-w-0 items-center gap-3 text-slate">
          <Image src="/logo.svg" alt="Champion Logistics" width={160} height={32} priority className="h-auto w-auto max-w-[140px] sm:max-w-[160px]" />
        </Link>
