  ...
  return (
    <section className="space-y-8">
      <div className="space-y-3">
        ...
        <h2 className="text-balance text-3xl font-semibold text-slate">Pricing Plans Tailored for You</h2>
      </div>

      <div className="grid gap-6 md:grid-cols-3">
        {plans.map((plan) => (
          <article key={plan.name} className="section-card flex min-w-0 flex-col justify-between gap-6">
            <div>
